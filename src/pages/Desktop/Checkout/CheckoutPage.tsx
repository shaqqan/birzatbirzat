                ...
                {deliveryTimeSlots.slice(1).map((slot) => (
                  <UnstyledButton
                    ...
                    className={`${classes.timeSlot} ${
                      selectedTimeSlot === slot.id ? classes.timeSlotActive : ""
                    }`}
                    onClick={() => setSelectedTimeSlot(slot.id)}
                  >
                    <Text className={classes.timeSlotLabel}>{slot.label}</Text>
                    <Text className={classes.timeSlotTime}>{slot.time}</Text>
                    {selectedTimeSlot === slot.id && (
                      <IconCheck size={16} className={classes.timeSlotCheck} />
                    )}
                  </UnstyledButton>
                ))}
              </div>
      ...
      <div className={classes.sidebar}>
        <Paper className={classes.summaryCard} radius="lg" p="xl">
          ...
          <Group justify="space-between" align="center">
            ...
            <Text className={classes.totalValue}>{formatPrice(total)} сум</Text>
          </Group>
